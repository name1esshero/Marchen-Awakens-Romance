...
sub_08013028:
	...
	mov r1, r9
	adds r2, r4, #0
	bl RuntimeObjectSetField4A
	adds r0, r6, #0
	mov r1, r9
	adds r2, r4, #0
	bl RuntimeObjectSetField4C
	movs r1, #1
	negs r1, r1
	movs r5, #4
	movs r2, #143
...
_0801362A:
	...
	movs r0, #0
	ldrsb r0, [r5, r0]
	bl RuntimeActorGetField340
	adds r4, r0, #0
	movs r0, #0
	ldrsb r0, [r5, r0]
	bl RuntimeActorGetField33C
	cmp r4, r0
	bne _08013720
	movs r0, #0
	ldrsb r0, [r5, r0]
...
sub_080146EC:
	...
	movs r1, #0
	ldrsb r1, [r5, r1]
	bl RuntimeObjectGetWord20
	str r0, [sp, #44]
	movs r0, #0
	ldrsb r0, [r4, r0]
	movs r1, #0
	ldrsb r1, [r5, r1]
	bl RuntimeObjectGetWord24
	adds r3, r0, #0
	str r3, [sp, #48]
	ldr r4, [sp, #64]
	ldr r0, [r4, #0]
...
sub_080164BA:
	...
	strh r0, [r4, #4]
	bl GameStateGetField424C
	asrs r0, r0, #16
	strh r0, [r4, #10]
	bl GameStateGetField4250
	asrs r0, r0, #16
	strh r0, [r4, #12]
	ldr r0, _08016550
	movs r1, #0
