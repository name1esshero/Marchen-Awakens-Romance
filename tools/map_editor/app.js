...
$('undo').onclick=undoEdit;$('redo').onclick=redoEdit;$('calls').onchange=drawArgs;$('call-filter').oninput=drawCalls;$('palette').onchange=drawTiles;for(const id of ['zoom','grid','layer','hit-preview','sprite-guide'])$(id).onchange=drawMap;
