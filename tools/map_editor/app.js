...
let map=null,script=null,selectedTile=0,dirty=false,busy=false,stroke=null,eventDrag=null,visible=[],undo=[],redo=[],atlas=new Map(),catalog=null,mode='map',tool='pencil',marscriptDoc=null,scriptEditorDirty=false;
