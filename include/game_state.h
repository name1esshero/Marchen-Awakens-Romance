...
s32 BattlePartyFindDefaultIndex(s32 id);
s32 BattlePartyGetDefaultId(s32 index);
bool32 GameStateHasField3880Value22(void);
void GameStateRecordSetField2(s32 id, s32 value);
void GameStateRecordAddField2(s32 id, s32 value);
