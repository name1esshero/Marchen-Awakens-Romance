...
/** Return the game-state value at offset 0x4265. */
...
/** Store the game-state value at offset 0x425C. */
...
/** Return the game-state value at offset 0x4269. */
AT("000070F8") s32 GameStateGetField4269(void) { return FIELD(s8,0x4269); }
/** Store the game-state value at offset 0x4269. */
